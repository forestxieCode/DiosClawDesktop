...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWorkingDirectoryHint: 'DiosClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 DiosClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 DiosClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'DiosClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkPermissionDescription: 'DiosClaw 请求执行以下操作',
    coworkToolName: '工具名称',
  ...
  en: {
    ...
    coworkSettings: 'DiosClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'DiosClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for DiosClaw...',
    coworkSystemPromptHint: 'Optional system prompt to customize DiosClaw\'s behavior',
    ...
    coworkModelSettingsHint: 'DiosClaw uses the current model and provider configuration from Model Settings.',
    ...
    coworkPermissionDescription: 'DiosClaw is requesting to perform the following action',
