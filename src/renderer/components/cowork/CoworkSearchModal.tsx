...
const CoworkSearchModal: React.FC<CoworkSearchModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="modal-content w-full max-w-2xl mt-10 rounded-2xl border dark:border-dark-border border-border dark:bg-dark-surface bg-surface shadow-modal overflow-hidden"
        role="dialog"
        aria-modal="true"
        aria-label={i18nService.t('search')}
        onClick={(event) => event.stopPropagation()}
      >
        <div className="flex items-center gap-3 px-4 py-3 border-b dark:border-dark-border border-border">
        ...
        <div className="px-3 py-3 max-h-[60vh] overflow-y-auto">
          {filteredSessions.length === 0 ? (
            <div className="py-10 text-center text-sm dark:text-dark-text-secondary text-text-secondary">
