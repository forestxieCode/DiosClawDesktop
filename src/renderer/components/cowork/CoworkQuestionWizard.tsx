...
const CoworkQuestionWizard: React.FC<CoworkQuestionWizardProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center modal-backdrop">
      <div className="modal-content w-full max-w-2xl mx-4 dark:bg-dark-surface bg-surface rounded-2xl shadow-modal overflow-hidden">
        {/* Header */}
        <div className="flex items-center gap-3 px-6 py-4 border-b dark:border-dark-border border-border">
          ...
          <button
            onClick={handleDeny}
            className="p-2 rounded-lg dark:hover:bg-dark-surface-hover hover:bg-surface-hover dark:text-dark-text-secondary text-text-secondary transition-colors"
            aria-label="Close"
          >
        ...
        {/* Progress bar */}
        <div className="h-1 bg-surface-muted dark:bg-dark-surface-muted">
          <div
          ...
          <div className="flex-1">
            ...
            <div className="flex items-start justify-between gap-4 mb-4">
              <div className="flex-1">
                {currentQuestion.header && (
                  <span className="inline-block text-[11px] uppercase tracking-wide px-2 py-1 rounded-full bg-surface-hover dark:bg-dark-surface-hover dark:text-dark-text-secondary text-text-secondary mb-3">
                    {currentQuestion.header}
                  </span>
                )}
                {/* Question text */}
              ...
              <div className="flex items-center gap-2">
                ...
                {!isFirstStep && (
                  <button
                    ...
                    className="p-1.5 rounded-lg dark:text-dark-text text-text-primary dark:hover:bg-dark-surface-hover hover:bg-surface-hover transition-colors"
                      ...
                      <button
                        ...
                        className={`relative flex items-center justify-center w-7 h-7 rounded-full text-xs font-medium transition-all ${
                          isActive
                            ...
                            : 'bg-surface-hover dark:bg-dark-surface-hover text-text-secondary dark:text-dark-text-secondary hover:bg-primary/20 dark:hover:bg-primary/20 hover:scale-105'
                        }`}
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left rounded-lg border px-4 py-3 transition-all ${
                      isSelected
                        ? 'border-primary bg-primary/10 text-text-primary dark:text-dark-text shadow-sm'
                        : 'border-border dark:border-dark-border dark:text-dark-text-secondary text-text-secondary hover:bg-surface-hover dark:hover:bg-dark-surface-hover hover:border-primary/50'
                    }`}
                  >
            ...
            <div className="mt-4 flex items-center gap-3">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-lg border dark:border-dark-border border-border dark:bg-dark-bg bg-page dark:text-dark-text text-text-primary placeholder:text-text-secondary dark:placeholder:text-dark-text-secondary focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm"
              />
              <button
                type="button"
                onClick={handleSkip}
                className="px-4 py-2 text-sm font-medium rounded-lg dark:text-dark-text-secondary text-text-secondary dark:hover:bg-dark-surface-hover hover:bg-surface-hover transition-colors whitespace-nowrap"
              >
        ...
        {/* Footer */}
        <div className="flex items-center justify-end px-6 py-4 border-t dark:border-dark-border border-border bg-surface-muted dark:bg-dark-surface-muted">
          <button
            onClick={handleSubmit}
            className="px-5 py-2 text-sm font-medium rounded-lg bg-primary hover:bg-primary-light text-white transition-colors"
          >
