...
This guide walks through testing the entire Web Search Skill integration with DiosClaw.

## Prerequisites

1. DiosClaw built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with DiosClaw.

**Steps:**

1. Start DiosClaw in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of DiosClaw launch.
...
1. Open a terminal while DiosClaw is running
...
**Objective:** Verify graceful shutdown of services when DiosClaw quits.

**Steps:**

1. With DiosClaw running and searches completed, quit the application
...
1. Start DiosClaw (ensure headless is false in config)
...
- ✅ Server auto-starts with DiosClaw
